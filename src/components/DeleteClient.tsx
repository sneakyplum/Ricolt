...
import { deleteClient } from "@/app/actions/client-table.action";
...
interface DeleteClientComponentProps {
  clientDelete: {
    id: string;
  }
}

const DeleteClient = ({ clientDelete }: DeleteClientComponentProps) => {

  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const deletedClient = await deleteClient(clientDelete.id);
